    ...
    extends consoleCommandBase
{
    ...
    protected function defineArguments()
    {
        ...
        $this->addOption('child_memory_limit', null, InputOption::VALUE_OPTIONAL, 'Memory limit for child processes in Mb [10]');
    }
    ...
    protected function handle(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($childMemoryLimit > 0) {
            self::log()->addNotice("Enabled childs memory control, max allowed memory [{$childMemoryLimit} Mb].");
